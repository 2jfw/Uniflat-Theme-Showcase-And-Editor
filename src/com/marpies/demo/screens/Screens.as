package com.marpies.demo.screens
{
	...
	public class Screens
	{
		...
		public static const ALERT_CALLOUT : String   = "alertCallout";
		public static const AUTO_COMPLETE : String   = "settings";
		public static const BUTTON : String          = "button";
		public static const GROUPED_LIST : String    = "groupedList";
		public static const ITEM_RENDERER : String   = "customItemRenderer";
